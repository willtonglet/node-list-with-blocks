...
describe("Reducers::Nodes", () => {
  ...
  it("should handle BLOCK_STATUS_LOADING", () => {
    const appState = {
      blocks: { loading: true, list: [] },
    };
    const action = { type: ActionTypes.BLOCK_STATUS_LOADING, node: nodeA };
    const expected = {
      blocks: { loading: true, list: [] },
    };
  ...
  it("should handle BLOCK_STATUS_SUCCESS", () => {
    const appState = {
      blocks: { loading: false, list: [] },
    };
    const action = {
  ...
  it("should handle BLOCK_STATUS_ERROR", () => {
    const appState = {
      blocks: { loading: false, list: [] },
    };
    const action = { type: ActionTypes.BLOCK_STATUS_ERROR, node: nodeA };
    const expected = {
      blocks: { loading: false, list: [] },
    };
